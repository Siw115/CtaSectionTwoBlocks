...
const CTASectionTwoBlocks = () => {
    return (
        <section className="w-full bg-[#FFFCFA] px-[64px] pt-[64px] pb-[96px]">
            <div className="max-w-[1312px] mx-auto flex flex-col items-center gap-[80px]">
                {/* Headline */}
             ...
             text-center w-[642px] h-[98px]">
                ...
                {/* CTA Blocks */}
                <div className="flex flex-col md:flex-row gap-[24px] w-full justify-center">
                    {[1, 2].map((_, i) => (
                        <div
                            key={i}
                            className="relative w-full md:w-[644px] h-[252px] md:h-[515px] rounded-[4px] overflow-hidden"
                        >
                            <img
